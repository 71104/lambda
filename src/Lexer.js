function Lexer(input) {
	...
	function next() {
		if (match(/^(\s|(#.*\n))+/)) {
			return next();
		} else if (match(/^(null|undefined|true|false|not|and|or|xor|fix|this|new|bool|void|unknown|int|float|string|regex|let|in|if|then|else|throw|try|catch|finally|error)\b/)) {
