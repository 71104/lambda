...
module.exports.testTypeOfKeyword = testTokens('typeof', ['keyword:typeof']);
...
module.exports.testBooleanKeyword = testTokens('boolean', ['keyword:boolean']);
module.exports.testUnknownKeyword = testTokens('unknown', ['keyword:unknown']);
module.exports.testIntegerKeyword = testTokens('integer', ['keyword:integer']);
module.exports.testRealKeyword = testTokens('real', ['keyword:real']);
module.exports.testComplexKeyword = testTokens('complex', ['keyword:complex']);
...
module.exports.testFunctionKeyword = testTokens('fn', ['keyword:fn']);
