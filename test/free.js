...
function testSet(expression, variables) {
  return function (test) {
    var ast = Lambda.parse(expression);
...
module.exports.testStringLiteral1 = testSet('"hello"', []);
module.exports.testStringLiteral2 = testSet('\'hello\'', []);
...
module.exports.testOperation = testSet('x + y * z', ['+', '*', 'x', 'y', 'z']);
module.exports.testComparison = testSet('x = y < z', ['=', '<', 'x', 'y', 'z']);
